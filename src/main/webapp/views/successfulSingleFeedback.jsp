	...
	<body>
		...
		<form class="form-signin" style="width:300px; margin:100px auto 20px auto;" action="/SecureApp/addUser" method="post" >
		  ...
		  <div class="text-center mb-4">
		    <h1 class="h3 mb-3 font-weight-normal">Your result:</h1><br>
		  </div>
		</form>
		<div class="container">
		    <!-- Example row of columns -->
		   	<div class="row">
		      	<div class="col-md-12">
					<h1 class="h3 mb-3 font-weight-normal">Name: ${feedback.name}</h1>
					<h1 class="h3 mb-3 font-weight-normal">Email: ${feedback.email}</h1>
					<h1 class="h3 mb-3 font-weight-normal">Message: ${feedback.message}</h1>
		    		<h1 class="h3 mb-3 font-weight-normal">Regarding: ${feedback.regarding}</h1>
		    		<h1 class="h3 mb-3 font-weight-normal">Code: ${feedback.code}</h1>
		    		<h1 class="h3 mb-3 font-weight-normal">Rating: ${feedback.rating}</h1>
				</div>
			</div>
		</div>		
	<script>
